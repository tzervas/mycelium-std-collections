# Gap status — `mycelium-std-collections`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-std-collections` |
| **Role** | std.collections |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-std-collections-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Ergonomics vs Python list/dict expectations |
